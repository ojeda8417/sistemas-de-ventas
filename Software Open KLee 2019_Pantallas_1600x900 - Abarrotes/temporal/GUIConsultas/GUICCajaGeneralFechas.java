 ...
 * @author Usuario-Pc
 */
public class GUICCajaGeneralFechas extends javax.swing.JFrame {

    /**
     * Creates new form GUICCajaCierre
     */
    public GUICCajaGeneralFechas() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String urlreporte = "src\\Reportes\\R_CajaGeneralFecha.jasper";
            Map parametros = new HashMap();
            parametros.put("fechacaja", jDateChooser1.getDate());
            ...
            ventana.setTitle("HISTÓRICO DE CAJA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUICCajaGeneralFechas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUICCajaGeneralFechas().setVisible(true);
            }
        });
    }
