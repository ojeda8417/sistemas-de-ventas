 ...
 * @author Usuario-Pc
 */
public class GUICComprasxFechas extends javax.swing.JFrame {

    /**
     * Creates new form FRM_CADUCIDADES
     */
    public GUICComprasxFechas() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String urlreporte = "src\\Reportes\\R_ComprasxFechas.jasper";
            Map parametros = new HashMap();
            parametros.put("fechac1", jDateChooser1.getDate());
            parametros.put("fechac2", jDateChooser2.getDate());
            ...
            ventana.setTitle("INFORME DE COMPRAS POR RANGOS DE FECHAS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUICComprasxFechas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUICComprasxFechas().setVisible(true);
            }
        });
    }
