...
public class ReportFactura {
 ...
 public boolean verReporteExistente(String rutaJRXML){
    ...
    public boolean generarNuevoReporte(String rutaJRXML, HashMap<String, Object> parametros, ArrayList<ProductoFactura> datos){
        try {
            File reportFile = new File(rutaJRXML);
            JasperDesign design = JRXmlLoader.load(reportFile);
            JasperReport reporte = JasperCompileManager.compileReport(design);
    ...
    private void verReporte(JRViewer jrv) {
        ...
        report.setTitle("Impresión de Factura");
    ...
    public static void main(String[] args) {
        ...
        if(generar.verReporteExistente("src\\Reportes\\GraficaProductos.jrxml")){
