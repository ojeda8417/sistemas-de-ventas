...
public class Excel {
    ...
    public Excel (List<JTable> tab, File ar) throws Exception {
        this.archi = ar;
        this.tabla = tab;
        if (tab.size() < 0) {
    ...
    private void createColumna(WritableSheet sheet, String columna, int number_columna) throws WriteException {
        ...
        WritableFont times12pt = new WritableFont(WritableFont.TAHOMA, 12);
...
//        formato_columna.setWrap(true);
        ...
        cv.setAutosize(true);
        addColumna(sheet, number_columna, 0, columna, formato_columna);/*Numero de columna, 0 es la fila*/ //aqui
    ...
    private void createFilas(WritableSheet sheet, int number_columna, int filas, String name_filas) throws WriteException {
        ...
        /*Crea una negrita con subrayado*/
        WritableFont times12ptBoldUnderline = new WritableFont(WritableFont.ARIAL, 12, WritableFont.NO_BOLD, false, UnderlineStyle.NO_UNDERLINE);
        formato_fila = new WritableCellFormat(times12ptBoldUnderline);
...
//        formato_fila.setWrap(true);
        ...
        addFilas(sheet, number_columna , filas + 1, name_filas, formato_fila);
