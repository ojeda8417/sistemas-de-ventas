 ...
 * @author Usuario
 */
public class ReportsProdCad {
    
private conectar CON;

    public ReportsProdCad() {
    }
    ...
    public boolean generarNuevoReporte(String rutaJRXML, HashMap<String, Object> parametros, ArrayList<ProductCaducidad> datos){
        try {
            File reportFile = new File(rutaJRXML);
            JasperDesign design = JRXmlLoader.load(reportFile);
            JasperReport reporte = JasperCompileManager.compileReport(design);
    ...
    public static void main(String[] args) {
        ReportsProdCad generar = new ReportsProdCad();
        if(generar.verReporteExistente("src\\Reportes\\R_Caducidades.jrxml")){
